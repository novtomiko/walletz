        ...
        <div class="col-lg">
          <div class="p-5">
            ...
            <form class="user" method="post" action="<?= base_url('register'); ?>">
              ...
              <div class="form-group">
                <input type="text" class="form-control form-control-user" id="email" name="email" placeholder="Alamat Email" value="<?= set_value('email'); ?>"> <?= form_error('email', '<smallclass="text-danger pl-3">', '</small>'); ?>
              </div>
