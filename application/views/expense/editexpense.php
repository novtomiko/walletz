        ...
        <form action="<?= base_url('expenses/save/'.$expense->expense_id)?>" method="post">
            <table>
                <tr>
                    ...
                    <td><input type="text" class="form-control form-control-user" id="name" name="name" value="<?= $expense->expense_name ?>"></td>
                    <td><small><?= form_error('name') ?></small></td>
                </tr>
                <tr>
                    <td><label for="amount">Amount:</label></td>
                    <td><input type="number" class="form-control form-control-user" id="amount" step="0.01" name="amount" value="<?= $expense->expense_amount ?>"></td>
                    <td><small><?= form_error('amount') ?></small></td>
                </tr>
                <tr>
                    <td><label for="date">Date:</label></td>
                    <td><input type="date" class="form-control form-control-user" id="date" name="date" value="<?= $expense->expense_date ?>"></td>
